...
ffmpeg ${FFMPEG_GLOBAL_OPTS} \
  ...
  -f hls \
    ...
    -hls_flags +append_list+delete_segments+discont_start+program_date_time+independent_segments \
    \
    -var_stream_map "a:0,name:audio-128k,agroup:audio,default:yes v:0,name:video-720p,agroup:audio v:1,name:video-360p,agroup:audio" \
    \
